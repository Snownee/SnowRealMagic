...
@KiwiPacket(value = "land_effect", dir = Direction.PLAY_TO_CLIENT)
public class SSnowLandEffectPacket extends PacketHandler {
	...
	public static void send(Level level, BlockPos pos, int originLayers, int layers) {
		I.send(PacketDistributor.NEAR.with(TargetPoint.p(pos.getX(), pos.getY(), pos.getZ(), 16, level.dimension())), buf -> {
